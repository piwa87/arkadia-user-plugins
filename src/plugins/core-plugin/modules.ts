...
export {
  ...
  subscribeKnowledgeReport,
} from './knowledge/report-data';
export { setupNearestKnowledgeAlias } from './knowledge/nearest-alias';
...
export { setupPok } from './pokoniuchy';
...
export { setupTravelAliases } from './movement/travel_aliases';
export { setupTro } from './trolle';
export { setupWsiadaczAliases } from './movement/wsiadacz';
...
export { setupPartyShieldAliases } from './walka/zaslony';
export { setupPrzelamAliases } from './walka/v';
export { setupWalker } from './movement/walker';
