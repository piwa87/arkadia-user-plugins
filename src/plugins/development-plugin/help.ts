...
const HELP_SECTIONS: Section[] = [
  ...
  },
  {
    title: 'Grabież',
    entries: [
      { syntax: 'w1–w8',         desc: 'weź wszystko z trupy #N' },
      { syntax: 'm1–m8',         desc: 'weź monety z trupy #N' },
      { syntax: 'b1–b8',         desc: 'weź broń z trupy #N' },
      { syntax: 'mx',            desc: 'monety ze wszystkich trup (1–8)' },
      { syntax: 'mz',            desc: 'monety + kamienie ze wszystkich trup' },
      { syntax: 'we <przedmiot>', desc: 'weź z pojemnika (/wzp)' },
      { syntax: 'wl <przedmiot>', desc: 'włóż do pojemnika (/wdp)' },
      { syntax: 'wem',           desc: 'weź monety z pojemnika (/wem)' },
      { syntax: 'wlm',           desc: 'włóż monety do pojemnika (/wlm)' },
    ],
  },
  {
    title: 'Statystyki',
    entries: [
      ...
      { syntax: 'statreset', desc: 'resetuj licznik zabić sesji' },
      { syntax: 'ob_show',   desc: 'popup walki: blok / parada / unik' },
      { syntax: 'ob_reset',  desc: 'resetuj statystyki walki' },
      { syntax: 'resetall',  desc: 'resetuj wszystkie liczniki naraz' },
    ],
  },
  {
    title: 'Zioła',
  ...
  },
  {
    title: 'Lampa',
    entries: [
      { syntax: 'naplam', desc: 'uzupełnij lampę olejem' },
    ],
  },
];
